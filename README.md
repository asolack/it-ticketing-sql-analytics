...
2. Run `sql/sql/01_seed_data.sql`
3. Run `sql/sql/02_constraints.sql`
4. Run `sql/sql/03_views.sql`
5. Run `sql/sql/04_materialized_views.sql`
6. Run `sql/sql/05_refresh_functions.sql`
